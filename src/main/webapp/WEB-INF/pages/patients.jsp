                        ...
                        <tr>
                            ...
                            <td width="23%">
                                ...
                                <a type="submit" class="btn btn-default"
                                   href="${pageContext.request.contextPath}/patients/disharge?id=<c:out value='${patient.id}' />">
                                    <i class="material-icons">clear</i>
                                </a>
                                <a type="submit" class="btn btn-default"
                                   href="${pageContext.request.contextPath}/patients/assignments?id=<c:out value='${patient.id}'/>">
                                    <i class="material-icons">list</i>
                                </a>
                                <a type="submit" class="btn btn-default"
                                   href="${pageContext.request.contextPath}/patients/clear?id=<c:out value='${patient.id}'/>">
