                    ...
                    <table id="table" class="table table-striped table-bordered">
                        ...
                        <c:forEach var="ass" items="${assignments}">
                            <tr>
                                ...
                                <td>
                                    <a class="btn btn-success btn-list"
                                       href="${pageContext.request.contextPath}/assignments/edit?id=<c:out value='${ass.id}' />">Edit</a>
                                    &nbsp;&nbsp;&nbsp;&nbsp;
                                    <a class="btn btn-secondary btn-list"
                                       href="${pageContext.request.contextPath}/assignments/delete?id=<c:out value='${ass.id}' />">Delete</a>
                                    &nbsp;&nbsp;&nbsp;&nbsp;
